...
- (UIView *)topLineView {
    if (!_topLineView) {
        ...
        if ((barStyle = UIBarStyleBlackTranslucent)) {
            [_topLineView setBackgroundColor:[UIColor colorWithRed:0.09 green:0.12 blue:0.15 alpha:1.0]];
        } else {
...
- (UIToolbar *)backgroundView {
    if (!_backgroundView) {
        ...
        [_backgroundView setBarStyle:barStyle];
...
- (UIView *)textContainer {
    if (!_textContainer) {
        ...
        if ((barStyle = UIBarStyleBlackTranslucent)) {
            [_textContainer setBackgroundColor:[UIColor colorWithRed:0.16 green:0.19 blue:0.22 alpha:1.0]];
        } else {
        ...
        if ((barStyle = UIBarStyleBlackTranslucent)) {
            UIColor *borderColor = [UIColor colorWithRed:0.12 green:0.14 blue:0.16 alpha:1.0];
...
- (UITextView *)textView {
    if (!_textView) {
        ...
        if ((barStyle = UIBarStyleBlackTranslucent)) {
            [_textView setBackgroundColor:[UIColor colorWithRed:0.16 green:0.19 blue:0.22 alpha:1.0]];
...
- (UILabel *)placeholderLabel {
    if (!_placeholderLabel) {
        ...
        if ((barStyle = UIBarStyleBlackTranslucent)) {
            [_placeholderLabel setBackgroundColor:[UIColor colorWithRed:0.16 green:0.19 blue:0.22 alpha:1.0]];
        } else {
